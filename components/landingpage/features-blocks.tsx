      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20 text-white">
            <h2 className="h2 mb-4">Nuestra identidad</h2>
            <p className="text-xl text-gray-300"> Somos una iniciativa que promete impactar positivamente en la gestión del agua de manera eficiente, sostenible e innovadora.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Ecoplantas</h4>
              <p className="text-gray-600 text-center">Diseños personalizados sostenibles.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Filtrados ecologicos</h4>
              <p className="text-gray-600 text-center">Ingenieria y reutilización del agua gris.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Energias renovables </h4>
              <p className="text-gray-600 text-center">eficiencia energetica.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Digitalizacion</h4>
              <p className="text-gray-600 text-center">Monitoreo en tiempo real.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Desechos Circulares</h4>
              <p className="text-gray-600 text-center">Gestion economica circular.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Marketing sustentable</h4>
              <p className="text-gray-600 text-center">identidad a nuestros usuarios.</p>
            </div>
          </div>
